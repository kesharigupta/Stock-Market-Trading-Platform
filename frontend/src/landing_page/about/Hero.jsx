...
function Hero() {
    return ( 
       <div className="container">
        ...
        <div className="row mt-5 border-top text-muted fs-5">
            ...
            <div className="col-6 p-5">
                <p className='mt-2'>In addition, we run a number of popular open online educational and community initiatives to empower retail traders and investors.</p>
